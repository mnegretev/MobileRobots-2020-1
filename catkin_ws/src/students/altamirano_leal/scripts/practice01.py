...
def callback_dfs(req):
    ...
    open_list      = deque()#creamos una lista que usaremos como cola
    ...
    while len(open_list) > 0 and current != goal_idx:
    	#Retiramos un elemento de la lista pero en ves de retirarlo por la izquierda lo retiramos por la derecha para que el comportamiento 
    	#sea el de una cola 
