...
def callback_laser_scan(msg):#msg es una variable de tipo laserScan
    ...
    #
    global obstacle_detected #variable global para saber si se detuvo el obstaculo
...
def main():
    ...
    pub_cmd_vel = rospy.Publisher("/hardware/mobile_base/cmd_vel", Twist, queue_size=10)#este es el publicador
    loop = rospy.Rate(10)
